...
<style>
    ...
    .hero-catalog h1 { font-family: 'Unbounded'; font-weight: 900; font-size: 3.5rem; letter-spacing: -2px; }
    .hero-catalog h1 span { color: var(--soft-pink); }
    ...
    <div class="slider-wrapper">
        <div class="track-container" id="mainSlider">
            ...
            <div class="slider-card">
                ...
                {{-- Data total_dipinjam dari hasil COUNT database --}}
                <div class="borrow-stats"><i class="fas fa-book-reader"></i> {{ $pb->total_dipinjam }}x</div>
                <div class="img-box" style="width: 100%; height: 240px; border-radius: 12px; overflow: hidden;">
                    @if($pb->cover)
                        <img src="{{ asset('storage/' . $pb->cover) }}" alt="{{ $pb->judul }}" style="width:100%; height:100%; object-fit: cover;">
                    @else
                ...
                <h3 class="book-title-small" style="margin-top: 10px;">{{ Str::limit($pb->judul, 28) }}</h3>
...
{{-- SECTION KOLEKSI UTAMA --}}
<section id="koleksi">
    <div class="book-grid" id="containerKoleksi">
        @forelse($books as $b)
        <div class="book-item">
            <div class="img-box" style="position: relative; width: 100%; height: 250px; border-radius: 12px; overflow: hidden; margin-bottom: 12px;">
                <span class="category-pill">{{ $b->kategori->nama ?? 'Umum' }}</span>
                @if($b->cover)
                    <img src="{{ asset('storage/' . $b->cover) }}" alt="{{ $b->judul }}" style="width:100%; height:100%; object-fit: cover;">
                @else
                    <div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; background:#1a1a2e;">
            ...
            <div class="book-info-container">
                ...
                <div class="b-meta">
                    ...
                    <div class="b-meta-row" style="margin-top: 5px; color: var(--lavender); font-weight: bold;">
                        <span><i class="fas fa-book-reader"></i> Dipinjam: {{ $b->total_dipinjam }}x</span>
                    </div>
                </div>
            </div>
        </div>
